...
#EDIT THE FOLLOWING:
$toAddress = "addyelk@gmail.com";  //place your/your client's email address here
$toName = "Addy Elketami"; //place your client's name here
$website = "its-addy.com";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<div>	
		<label>
			Comments:<br /><textarea name="Comments" cols="36" rows="4" placeholder="Comment Here!" tabindex="30"></textarea>
		</label>
	</div>	
	<div><?=$feedback?></div>
